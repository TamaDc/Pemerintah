                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <table border="0" style="width: 978px"; align="center">
                          ...
                          <div align="center">
                            <form class="form-horizontal" style="width: 978px"; role="form" method="POST" action="<?php echo base_url()."index.php/admin_template/update_template"; ?>">
                                <th width="150">
                                ...
                                <th >
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                      <input type="text" autocomplete="off" required="required" class="form-control" id="judul" name="judul" placeholder="BADAN KEPEGAWAIN PENDIDIKAN DAN PELATIHAN" value="<?php echo $data['judul']; ?>">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="kepada" required="required" name="kepada" placeholder="KEPALA BADAN PENGOLAHAN" value="<?php echo $data['kepada'] ?>">
                                      </div>
                                  </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <td>
                                       <div class="col-sm-10">
                                      <input type="text" class="form-control" id="peraturan" name="peraturan" placeholder="Nomor 30 Tahun 2015" value="<?php echo $data['peraturan']; ?>">
                                      </div>
                                  </td>
                                  </tr>
