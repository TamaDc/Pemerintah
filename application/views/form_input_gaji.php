                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <table border="0" style="width: 978px"; align="center">
                          ...
                          <div align="center">
                            <form class="form-horizontal" style="width: 978px"; role="form" method="POST" action="<?php echo base_url()."index.php/admin_gaji_lama/insert_II"; ?>" >
                                ...
                                <tr>  
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                      <input type="text" autocomplete="off" required="required" class="form-control" id="NIP" name="NIP" >
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="Nama" name="Nama" placeholder="*Rifqi Yunus">
                                      </div>
                                  </td>
                                  </tr>
                                  ...
                                  <td>
                                    <div class="col-sm-10">
                                      <input type="date"  class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="" value="">
                                    </div>
                                  </td>
                                  </tr>
