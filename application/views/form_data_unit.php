                        ...
                        <hr>
                          ...
                          <!-- form serach data -->          
                                    ...
                                    <tr style="background:#3f8fb7;">
                                      ...
                                      <th width="80"><center>Esselon</center></th>
                                      <th width="270"><center>Action</center></th>
                                    </tr>
                                    
                                    <?php foreach($db_unit_kerja as $row){ ?>
                                          <tr>
                                            <td><?php echo $row->id_unit_kerja ?> </td>
                                            <td><?php echo $row->nama_unit_kerja; ?> </td>
                                            <td><center><?php echo $row->esselon; ?></td>
                                             <td align="center">
                                              <a class="btn btn-primary" href="<?php echo base_url()."index.php/admin_jabatan/Edit/".$row->id_unit_kerja; ?>">Edit</a> |
                                              <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin_jabatan/delete/".$row->id_unit_kerja; ?>">Delete</a>
