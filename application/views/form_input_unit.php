                    ...
                    <div class="col-md-12">
                       ...
                       <hr>
                          ...
                          <div  class="alert alert-info2" >
                              <h2 align="center" >Input Data Unit Kerja</h2>
                          </div>
                          </br>
                            <form class="form-horizontal" style="width: 978px"; role="form" method="POST" action="<?php echo base_url()."index.php/admin_jabatan/insert_unit"; ?>">
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="nama_unit_kerja" name="nama_unit_kerja" value="">
                                      </div>
                                  </td>
                                  </tr>
                                  ...
                                  <td>  
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="esselon" name="esselon" value="">
                                    </div>
                                  </td>
                                  </tr>
