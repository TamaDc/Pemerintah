                        ...
                        <hr>
                          ...
                          <!-- form serach data -->
                                        ...
                                        <form class="form-inline" role="form" action="<?php echo base_url().'index.php/admin_pegawai/search_actor'; ?>" method="post">
                                          ...
                                          <a class="btn btn-default" href="<?php echo base_url()."index.php/admin_jabatan/tambah"?>">Tambah Data</a>
                          ...
                          <!-- form serach data -->          
                                    ...
                                    <?php foreach($jabatan as $row){ ?>
                                          <tr>
                                            ...
                                            <td align="center">
                                              <a class="btn btn-primary" href="<?php echo base_url()."index.php/admin_jabatan/Edit/".$row->kd_jabatan; ?>">Edit</a> |
                                              <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin_jabatan/delete/".$row->kd_jabatan; ?>">Delete</a>
