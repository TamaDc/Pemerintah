                    ...
                    <div class="col-md-12">
                       ...
                       <hr>
                          ...
                          <div  class="alert alert-info2" >
                            ...
                            <form class="form-horizontal" style="width: 978px"; role="form" method="POST" action="<?php echo base_url()."index.php/admin_jabatan/update"; ?>">
                                  <th width="150">
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                       <input type="text" class="form-control" id="kd_jabatan" name="kd_jabatan" readonly  value="<?php echo $jabatans['kd_jabatan']; ?>">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" value="<?php echo $jabatans['nama_jabatan']; ?>">
                                      </div>
                                  </td>
                                  </tr>
                                  ...
                                  <td>  
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="level" name="level" value="<?php echo $jabatans['level']; ?>">
                                    </div>
                                  </td>
                                  </tr>
