                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <table border="0" style="width: 978px"; align="center">
                          ...
                          <div align="center">
                            <form class="form-horizontal" style="width: 978px"; role="form" method="POST" action="<?php echo base_url()."index.php/admin_pegawai/insert"; ?>">
                                <tr>  
                                  <th width="150">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="col-sm-10">
                                      <input type="text" required="required"  class="form-control" id="skpd" name="skpd"value="">
                                    </div>
                                  </td>
                                  </tr>
                                  <tr><td>
                                  ...
                                  <tr><td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" required="required" id="pangkat" name="pangkat" value="">
                                    </div>
                                  </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="date" class="form-control" required="required" id="tanggal_lahir" name="tanggal_lahir"  value="">
                                    </div>
                                  </td>
                                </tr>
                                ...
                                <tr><td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" required="required" id="loker" name="loker"  value="">
                                    </div>
                                  </td>
                                  </tr>
                                  ...
                                  <tr><td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control"  id="nomer_sk" name="nomer_sk" placeholder="" value="">
                                    </div>
                                  </td>
                                  </tr>
                                  ...
                                  <td>
                                    <div class="col-sm-10">
                                      <input type="date"  class="form-control" id="tanggal_sk" name="tanggal_sk" placeholder="" value="">
                                    </div>
                                  </td>
                                  </tr>
                                  <tr><td>
                                      ...
                                      <td>
                                      <div class="col-sm-10">
                                      <input type="text" class="form-control"  id="masa_kerja_tahun" name="masa_kerja_tahun"  value="">
                                      </div>
                                      </td>
                                  </tr>
                                ...
                                <tr>
                                  <td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" required="required" id="gaji_pokok_lama" name="gaji_pokok_lama" placeholder="*3000000" value="">
                                    </div>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  <td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="date" class="form-control" required="required" id="tanggal_berlaku" name="tanggal_berlaku"  value="">
                                    </div>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  <td>
                                      ...
                                      <td>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" required="required" id="NIP_pejabat" name="NIP_pejabat" value="">
                                    </div>
                                  </td>
                                </tr>
